...
- Cloud Shell terminal reusable. Issue [#42](https://github.com/VSChina/vscode-ansible/issues/42).
- Show hover up document linking in role structure. Issue [#88](https://github.com/VSChina/vscode-ansible/issues/88).
- Improve code snippets triggering, no need of `ctril + space`. Issue [#90](https://github.com/VSChina/vscode-ansible/issues/90).
- Add new host option in run playbook via ssh command. Issue [#96](https://github.com/VSChina/vscode-ansible/issues/96).
- Add configuration to enable/disable auto completion. Issue [#93](https://github.com/VSChina/vscode-ansible/issues/93).


Thank you for reporting issue and provide valuable feedback!
- @azwanson for Issue [#88](https://github.com/VSChina/vscode-ansible/issues/88), Issue [#89](https://github.com/VSChina/vscode-ansible/issues/89).
- @moltar for Issue [#90](https://github.com/VSChina/vscode-ansible/issues/90).
- @tristan947 for Issue [#93](https://github.com/VSChina/vscode-ansible/issues/93).
- @zikalino for Issue [#96](https://github.com/VSChina/vscode-ansible/issues/96).

## 0.1.4
Fix below issues/bugs:
- Issue [#75](https://github.com/VSChina/vscode-ansible/issues/75) , [#63](https://github.com/VSChina/vscode-ansible/issues/63) , [#71](https://github.com/VSChina/vscode-ansible/issues/71) . Hover and symbol failed when yaml file format invalid.
- Issue [#67](https://github.com/VSChina/vscode-ansible/issues/67) . Execute playbook in subfolder inside docker failed.
- Issue [#77](https://github.com/VSChina/vscode-ansible/issues/77) . Execute playbook failed when workspace path contains white space.
- Issue [#80](https://github.com/VSChina/vscode-ansible/issues/80) . When remote ssh server default directory is not home dir, executing playbook failed.
